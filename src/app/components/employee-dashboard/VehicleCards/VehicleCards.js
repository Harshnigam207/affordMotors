...
export default function VehicleCards({ username, pageno, searchValue, vehiclesArray, setSelectedVehicle, setMakeVehicleVisible, setCancelVehicleVisible, setCancelError, handleSearch }) {
